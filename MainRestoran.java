...
public class MainRestoran {
    ...
    public static void main(String[] args) {
        ...
        kokiUtama = (Koki) restoran.daftarKaryawan.stream()
                .filter(k -> k instanceof Koki)
                .findFirst()
                .orElse(null);
        kasirUtama = (Kasir) restoran.daftarKaryawan.stream()
                .filter(k -> k instanceof Kasir)
                .findFirst()
                .orElse(null);
    ...
    private static void prosesPesanan() {
        ...
        while (!restoran.antrianPesanan.isEmpty() && diproses < jumlahProses) {
            ...
            if (!pesananDiproses.isDibatalkan() && 
                pesananDiproses.getListMakanan().stream()
                    .allMatch(m -> m.getStatusMakanan() == StatusMakanan.SIAP_SAJI)) {
